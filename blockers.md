...
purpose — decisions #1, #2, #3, #5, #6, #7, #8, #9, #10, #11, #12 and #13 are fully settled and
have moved to §4; #4 keeps its original number rather than being renumbered, so every
