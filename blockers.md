...
purpose — decisions #1, #2, #3, #5, #6, #7, #8, #9, #10 and #12 are fully settled and have moved
to §4; #4 and #11 keep their original numbers rather than being renumbered, so every
